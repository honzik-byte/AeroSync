...
export default async function DashboardPage() {
  try {
    ...
    if (isSupabaseSetupError(error)) {
      return (
        <SetupNotice
          title="Databáze AeroSync ještě není připravená"
          description="Aplikace se připojila do Supabase, ale v projektu ještě nejsou vytvořené tabulky AeroSyncu nebo neexistuje zadaný aeroklub."
        />
      );
    }
